...
```{r pen1, echo=TRUE, message=FALSE, warning=FALSE, fig.cap = "Cross-validation results for Ridge regression: optimal lambda selection"}
...
```{r pen2, echo=FALSE, message=FALSE, warning=FALSE}
# Define your own grid of lambda values
lambda_grid <- 10^seq(3, -2, length = 100)  # 100 values from 10^3 to 10^-2

# Fit Ridge regression with custom lambda grid
ridge_model <- glmnet(X_train, y_train, alpha = 0, lambda = lambda_grid)

# Perform cross-validation using the custom lambda grid
...
```{r pen3, echo=TRUE, message=FALSE, warning=FALSE, results='hide'}
...
```{r pen5, echo=TRUE, message=FALSE, warning=FALSE, fig.cap = "Cross-validation results for LASSO regression: optimal lambda selection"}
...
```{r pen6, echo=TRUE, message=FALSE, warning=FALSE, fig.cap = "Cross-validation results for Adaptive Lasso: optimal lambda selection"}
# Load necessary libraries
library(glmnet)
...
```{r pen7, echo=TRUE, message=FALSE, warning=FALSE, fig.cap = "Cross-validation results for Elastic Net: optimal lambda selection"}
# Load necessary libraries
library(glmnet)
