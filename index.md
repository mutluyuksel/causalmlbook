--- 
title: "Causal Inference and Machine Learning: In Economics, Social, and Health Sciences"
...
description: "A comprehensive machine learning textbook for economists, social scientists, and health researchers. Learn causal inference methods with practical R code examples. Covers econometric ML, casual methods, and applied research methods."
url: 'https://www.causalmlbook.com/'
github-repo: yourusername/yourreponame
...
<div style="display:flex; flex-wrap:wrap; align-items:flex-start; margin-bottom:2rem;">
  ...
  <div markdown="1" style="flex:1 1 55%; min-width:280px; padding-right:1rem;">
...
<!-- Right column: button ABOVE cover -->
<div markdown="1" style="flex:1 1 40%; min-width:260px; text-align:center;">
  ...
  <a href="https://www.routledge.com/Causal-Inference-and-Machine-Learning-In-Economics-Social-and-Health-Sciences/Yuksel-Aydede/p/book/9781032820415"
     target="_blank"
     style="display:inline-block; background:#004080; color:#fff; font-weight:700;
            padding:.65rem 1rem; border-radius:.5rem; text-decoration:none; margin-bottom:1rem;">
     Click to Pre-order
  </a>

  <img src="png/cover.png" alt="Book cover"
       style="width:100%; max-width:360px; box-shadow:0 4px 12px rgba(0,0,0,.12); border-radius:6px;">

</div>

<!-- force a new row below both columns -->
<div style="flex-basis:100%; height:0;"></div>

<!-- full-width continuation under the cover -->
<div markdown="1" style="flex:1 1 100%;">
...
\BeginKnitrBlock{flushright}<p class="flushright">Yigit Aydede  
Mutlu Yuksel</p>\EndKnitrBlock{flushright}
