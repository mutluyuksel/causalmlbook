...
In Chapter 13, we introduced decision trees as a flexible nonparametric approach for prediction. Here, we extend their use to causal inference by implementing a double machine learning (DML) approach with cross-fitting.
...
In Chapter 14, we covered random forests for prediction. Here, we extend their use to causal inference by implementing a DML approach with cross-fitting.
