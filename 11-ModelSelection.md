...
Bootstrap is particularly useful for estimating confidence intervals and assessing model uncertainty, which we covered in detail in Chapter Y. While cross-validation primarily focuses on prediction error estimation, bootstrap is more often used for uncertainty quantification in parameter estimates. 
