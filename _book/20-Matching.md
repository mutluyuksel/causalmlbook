...
Table: (\#tab:unnamed-chunk-1)Data for Matching Example

| <span style='font-weight:normal;'>ID</span>| <span style='font-weight:normal;'>$D_i$</span>|<span style='font-weight:normal;'>Parental<br>Income</span> | <span style='font-weight:normal;'>GPA</span>|<span style='font-weight:normal;'>SAT<br>Score</span> |<span style='font-weight:normal;'>Univ.<br>Type</span> |<span style='font-weight:normal;'>Field</span> | <span style='font-weight:normal;'>Earnings</span>|
|-------------------------------------------:|----------------------------------------------:|:-----------------------------------------------------------|--------------------------------------------:|:-----------------------------------------------------|:------------------------------------------------------|:----------------------------------------------|-------------------------------------------------:|
|                                           1|                                              1|High                                                        |                                          3.8|1400--1600                                            |Public                                                 |STEM                                           |                                             60000|
|                                           2|                                              0|High                                                        |                                          3.8|1400--1600                                            |Public                                                 |STEM                                           |                                             50000|
|                                           3|                                              1|Medium                                                      |                                          3.2|1201--1400                                            |Private                                                |Business                                       |                                             72000|
...
##   BinaryVar1 (mean (SD))    0.40 (0.49)   0.58 (0.49)  <0.001
```
...
##   BinaryVar1 (mean (SD))    0.51 (0.50)   0.58 (0.49)   0.026
```
...
##   BinaryVar1 (mean (SD))    0.57 (0.49)   0.58 (0.49)   0.949
```
...
```
## ATT (Mahalanobis Matching): 3.72427
```
...
<img src="20-Matching_files/figure-html/match2-1.png" width="672" />
...
Table: (\#tab:unnamed-chunk-2)Recommended Matching Methods Based on Scenarios

|<span style='font-weight:normal;'>Scenario</span> |<span style='font-weight:normal;'>Recommended Methods</span> |
|:-------------------------------------------------|:------------------------------------------------------------|
|Few treated units, large control group            |Nearest-neighbor matching, caliper or optimal matching       |
|High-dimensional covariates                       |Propensity score matching, kernel matching, machine learning |
|Poor overlap in covariates                        |Caliper matching, trimming                                   |
...
<img src="20-Matching_files/figure-html/match5-1.png" width="672" />
...
##   BinaryVar1 (mean (SD))    0.40 (0.49)   0.60 (0.49)  <0.001
```
...
##   BinaryVar1 (mean (SD))    0.54 (0.50)   0.60 (0.49)  <0.001
```
...
##   BinaryVar1 (mean (SD))    0.53 (0.50)   0.60 (0.49)  <0.001
```
...
##   BinaryVar1 (mean (SD))    0.55 (0.50)   0.54 (0.50)   0.926
```
...
```
## ATT (Propensity Score Matching): 3.136654
```
...
<img src="20-Matching_files/figure-html/match7-1.png" width="672" />
